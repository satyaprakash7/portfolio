...
var waypoint = new Waypoint({
  element: document.getElementById('experience'),
      ...
      p[4].setAttribute("style","width:85%;transition:2.5s all");
      p[5].setAttribute("style","width:85%;transition:1.5s all");
      p[6].setAttribute("style","width:85%;transition:1.3s all");
      p[7].setAttribute("style","width:75%;transition:1.5s all");
      },
      offset:'90%'
    });
...
$('.img-loaded').imagesLoaded()
  ...
  strings: ["Satya Prakash", "a Web Developer","a FrontEnd Developer","a Designer"],
  smartBackspace: true,
   typeSpeed: 100,
   backSpeed: 100,
   loop: true,
